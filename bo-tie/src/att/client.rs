use crate::att::{pdu, server::ServerPduName, TransferFormatError, TransferFormatInto, TransferFormatTryFrom};
use crate::l2cap;
...
pub trait ResponseProcessor {
    ...
    fn process_response(self, acl_data: &l2cap::BasicInfoFrame) -> Result<Self::Response, super::Error>;
}
    ...
    C: l2cap::ConnectionChannel,
{
    ...
    pub async fn create_client(self, response: &l2cap::BasicInfoFrame) -> Result<Client<'c, C>, super::Error> {
