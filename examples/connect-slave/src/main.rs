...
async fn events_setup<M: Send + 'static>(hi: &hci::Host<bo_tie_linux::HCIAdapter, M>) {
...
async fn advertise_setup<M: Send + 'static>(hi: &hci::Host<bo_tie_linux::HCIAdapter, M>, local_name: &str) {
